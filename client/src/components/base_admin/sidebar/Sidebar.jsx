...
const Sidebar = () => {
  return (
    <aside className="fixed transition transform ease-in-out duration-1000 z-50 flex h-scree  bg-color-primary rounded border border-gray-700">
